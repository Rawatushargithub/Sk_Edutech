...
//courseInterested not working properly field are not sending on backend 
//   import React, { useState , useEffect } from "react";
// import axios from "axios";
// import Fees_table from "./Fees_table";
// import { ToastContainer, toast } from 'react-toastify';
...
//     // Send courseInterested as a JSON string instead of nested FormData
...
//     try {
//       console.log("Submitting form data before posting :", formDataToSend);
//       const response = await axios.post( 
//         "http://localhost:8000/api/v1/institute_student/register_student",
