        ...
        <div className="px-6 pb-6 pt-4">
          ...
          <div className="flex flex-col space-y-3">
            ...
            <div className="flex items-center space-x-3">
              <button
                onClick={onViewForm}
                className="flex-grow py-2.5 bg-sky-900 text-white rounded-lg font-medium hover:bg-sky-800 transition-colors flex items-center justify-center space-x-2"
              >
                <svg
                  className="w-5 h-5"
                  fill="none"
              ...
              <button
                ...
                className="flex items-center justify-center w-12 h-12 bg-emerald-500 text-white rounded-lg hover:bg-emerald-600 transition-colors"
                title="View ID Card"
              >
