...
// --- Center Frontend Specific Service ---

// For fetching the franchise (institute) data by ID
// const API_BASE_URL = "http://localhost:5000/api/v1/franchises"; // Adjust as needed

// export const getFranchiseById = async (franchiseId) => {
//     try {
//         const response = await axios.get(`${API_BASE_URL}/${franchiseId}`);
//         return response.data;
//     } catch (error) {
//         throw error.response?.data || new Error("Failed to fetch franchise data");
//     }
// };