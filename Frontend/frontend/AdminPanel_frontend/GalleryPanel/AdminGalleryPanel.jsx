  ...
  return (
    <div className="p-6">
      ...
      <form
        ...
        className="max-w-4xl mb-8 p-6 bg-gray-100 rounded-lg"
      >
        <div className="mb-4">
        ...
        <button
          ...
          className="px-4 py-2 bg-black text-white rounded hover:bg-gray-300 hover:text-black cursor-pointer disabled:bg-gray-300"
        >
          {isUploading ? "Uploading..." : "Upload"}
        </button>

        {message && (
          <div className="mt-3 text-sm font-medium text-red-600">{message}</div>
        )}
      </form>
          ...
          <div className="bg-white rounded-lg p-6 max-w-md w-full mx-4">
            ...
            <div className="flex justify-end space-x-3">
              <button
                ...
                disabled={isDeleting}
                className="px-4 py-2 text-gray-600 border border-gray-300 rounded hover:bg-gray-100 cursor-pointer disabled:opacity-50"
              >
                Cancel
              </button>
              <button
...
// below code lacks scrollable gallery
// // AdminGalleryPanel.jsx
// import React, { useState, useEffect } from "react";
// import axios from "axios";
// import API_BASE_URL from "../../config";
