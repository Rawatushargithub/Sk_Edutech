...
const Wallet = () => {
  ...
  useEffect(() => {
    const fetchWalletData = async () => {
      setIsLoading(true);
      try {
        const response = await axios.get("http://localhost:8000/api/v1/wallet");
  ...
  const handleAddMoney = async (e) => {
    ...
    try {
      ...
      const createTransaction = await axios.post("http://localhost:8000/api/v1/wallet/transaction", {
  ...
  const handleConfirmTransaction = async (e) => {
    ...
    try {
      ...
      await axios.put("http://localhost:8000/api/v1/wallet/transaction/confirm", {
        upiTransactionId
      });
