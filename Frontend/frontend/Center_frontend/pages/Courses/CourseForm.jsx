          ...
          <div className="bg-white rounded-xl shadow-2xl p-6 sm:p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-6">
                ...
                <div><label htmlFor="courseName" className="block text-sm font-medium text-gray-700 required">Course Name  <span className="text-red-500 text-xs ml-2 font-normal">(Use full form — Will be printed on certificate)</span></label><input type="text" name="courseName" id="courseName" value={formData.courseName} onChange={handleInputChange}  placeholder="For ex : Machine Learning" required className={isEditMode ? disabledInputStyle : noRingInputStyle} disabled={isEditMode} /></div>
                <div><label htmlFor="courseSubject" className="block text-sm font-medium text-gray-700 required">Course Subject <span className="text-red-500 text-xs ml-2 font-normal">(Enter carefully —  Will be printed on certificate)</span></label><input type="text" name="courseSubject" id="courseSubject" value={formData.courseSubject} onChange={handleInputChange} placeholder='For ex : MS Excel , MS Word , MS Powerpoint' required className={isEditMode ? disabledInputStyle : noRingInputStyle} disabled={isEditMode} /></div>
